...
export interface TopRelease {
  ...
  title?: string;
  release_title?: string;
  release_name?: string;        // GET /top-releases uses this
  track_title?: string;         // GET /streams top_tracks uses this
  artist?: string;
  artists?: string;             // GET /top-releases uses this
  primary_artist?: string;
  streams?: number | string;
  total_streams?: number | string; // GET /top-releases and /streams use this
  plays?: number | string;
  cover?: string;
  album_art_url?: string;
  [key: string]: unknown;
...
export interface TopPlatform {
  platform?: string;            // GET /top-platforms uses this
  platform_name?: string;       // GET /streams platform_breakdown uses this
  name?: string;
  streams?: number;
  total_streams?: number;       // GET /top-platforms uses this
  percentage?: number;
  color?: string;
  countries?: number;
  unique_releases?: number;

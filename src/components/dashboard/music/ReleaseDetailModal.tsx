...
// /* ─── Platform display names — matches DSP keys from upload flow ─ */
// const PLATFORM_DISPLAY: Record<string, { name: string; description: string }> = {
//   spotify:       { name: "Spotify",       description: "Leading global streaming platform" },
//   apple_music:   { name: "Apple Music",   description: "Apple's premium streaming service" },
//   youtube_music: { name: "YouTube Music", description: "Google's music streaming platform" },
//   amazon_music:  { name: "Amazon Music",  description: "Amazon's streaming service" },
//   tidal:         { name: "Tidal",         description: "High-fidelity streaming" },
//   deezer:        { name: "Deezer",        description: "Global music streaming" },
//   audiomack:     { name: "Audiomack",     description: "African & global music" },
...
//   const info = PLATFORM_DISPLAY[platformKey] ?? { name: platformKey, description: "" };
...
//           <img src={logoUrl} alt={info.name} onError={() => setFailed(true)} className="w-full h-full object-contain" />
//         ) : (
...
//         <p className="font-body text-white text-sm font-medium truncate">{info.name}</p>
//         {info.description && <p className="font-body text-white/35 text-[11px] truncate">{info.description}</p>}
//       </div>
//     </div>
//   );
// }
...
//       <button className="w-8 h-8 rounded-full border border-white/20 flex items-center justify-center text-white/60 hover:text-white hover:border-white/40 transition-colors shrink-0">
//         <PlayIcon />
//       </button>
...
//       </div>
//       {track.isrc && <p className="font-body text-white/30 text-xs shrink-0 hidden sm:block">{track.isrc.slice(0, 10)}...</p>}
...
//                   <p className="font-body text-white text-xs">{value}</p>
//                 </div>
//               ))}
//             </div>

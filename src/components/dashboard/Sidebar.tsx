...
const MAIN_NAV = [
  { label: "Dashboard", href: "/dashboard", icon: "/images/home.svg" },
  {
    ...
    icon: "/images/dashboard-music.svg",
  },
...
const ARTIST_TOOLS = [
  ...
  {
    label: "Release Links",
    href: "/dashboard/release-links",
    icon: "/images/link.svg",
  },
  {
    label: "Playlist Portal",
    href: "/dashboard/playlist-portal",
    icon: "/images/playlist-broken.svg",
  },
];
        ...
        {collapsed ? (
          <div className="relative group/user">
            ...
            <div className="pointer-events-none absolute left-full top-1/2 -translate-y-1/2 ml-3 z-50 opacity-0 group-hover/user:opacity-100 transition-opacity duration-150">
              <div className="bg-[#1A0808] border border-white/[0.08] rounded-lg px-3 py-2 shadow-xl">
                <p className="font-heading text-white text-xs uppercase tracking-wide whitespace-nowrap">
                  {MOCK_USER.name}
                </p>
                <p className="font-body text-white/40 text-[10px] whitespace-nowrap">
                  {MOCK_USER.plan}
                </p>
              </div>
            </div>
          ...
          <div className="flex items-center gap-2.5 px-2 py-2 rounded-xl bg-white/[0.04] border border-white/[0.06]">
            ...
            <div className="min-w-0">
              <p className="font-heading text-white text-xs uppercase tracking-wide truncate">
                {MOCK_USER.name}
              </p>
              <p className="font-body text-white/40 text-[10px] truncate">
                {MOCK_USER.plan}
              </p>
            </div>
          </div>

...
const TESTIMONIALS = [
  ...
  {
    quote:
      "The way Songdis pushed my single across regions was crazy. They didn't just put my music on platforms: they helped market it to the right audience. With their help I saw more engagement from fans in the UK, Nigeria and South Africa.",
    name: "Reechdee",
    country: "Nigeria",
    flag: "🇳🇬",
  ...
  {
    quote:
      "They treat you like family, and not just a client. From helping me with cover art, to giving me tips, to how to promote my song, they were there. For someone like me still figuring things out, that kind of guidance is everything.",
    name: "Switorla",
    country: "Ghana",
    flag: "🇬🇭",
  ...
  {
    quote:
      "Songdis made it super easy to drop my debut single on every platform there is. I fixed in the necessary information and all I did was sit back till my release date. 10/10 would recommend.",
    name: "Bri Tse",
    country: "Nigeria",
    flag: "🇳🇬",
      ...
      <div className="hidden lg:flex w-[60%] p-4">
        <div className="flex-1 relative rounded-2xl overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 right-0 z-10 px-8 py-8">
            ...
            <p
              key={activeIndex}
              className="font-body text-white/90 text-sm leading-relaxed mb-5 transition-opacity duration-500"
            >
              {t.quote}
            </p>

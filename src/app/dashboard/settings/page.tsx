          ...
          {step === "info" && (
            <div className="flex flex-col gap-5">
              <div className="rounded-xl border border-dashed border-[#C30100]/30 p-4">
                <p className="font-montserrat text-white text-xs font-semibold mb-0.5">
                  Find Your Spotify Profile (Optional)
                </p>
              ...
              <Field label="Bio">
                ...
                />
                <p className="font-montserrat text-white/30 text-[11px]">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <Field label="Twitter">
                    <Input
                      value={twitter}
                      onChange={noTwitter ? undefined : setTwitter}
                ...
                <div>
                  <Field label="Instagram">
                    <Input
                      value={instagram}
                      onChange={noInstagram ? undefined : setInstagram}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <Field label="Facebook">
                    <Input
                      value={facebook}
                      onChange={noFacebook ? undefined : setFacebook}
                ...
                <div>
                  <Field label="TikTok">
                    <Input
                      value={tiktok}
                      onChange={noTiktok ? undefined : setTiktok}
              ...
              <div>
                <Field label="Apple Music (paste your artist page URL)">
                  <Input
                    value={appleMusic}
                    onChange={noAppleMusic ? undefined : setAppleMusic}
